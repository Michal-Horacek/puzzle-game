...
import com.game2.game.entity.E_Wall;
...
public class WallTest implements Test {
	...
	public void run() {
		...
		entityStack.add(new E_Wall(new Point2D(1, 1)));
		...
		if(activePlayer.getPosition2D().getX() == 1
			...
			System.out.println("Wall test OK.");
		}
		else {
			System.out.println("Wall test FAIL.");
		}
		...
		if(activePlayer.getPosition2D().getX() == 0
			...
			System.out.println("Undo - Wall test OK.");
		}
		else {
			System.out.println("Undo - Wall test FAIL.");
		}
	}
}
